...
trait CheckerTrait
{
	...
	protected function getComponents(): array
	{
		...
		$currentCurlVersion = (extension_loaded('curl') && function_exists('curl_version'))
			? data_get(curl_version(), 'version', '1.0.0')
			: '1.0.0';
		...
		$components = [
			...
			[
				...
				'warning'           => 'PHP bcmath extension is required.',
				'success'           => 'PHP bcmath extension is installed.',
			],
			[
				'type'              => 'component',
				...
				'permanentChecking' => true,
				'warning'           => 'PHP ctype extension is required.',
				'success'           => 'PHP ctype extension is installed.',
			],
			[
				'type'              => 'component',
				...
				'permanentChecking' => true,
				'warning'           => 'PHP curl extension <code>' . $requiredCurlVersion . '</code> or higher is required.',
				'success'           => 'PHP curl extension <code>' . $currentCurlVersion . '</code> is installed.',
			],
			[
				'type'              => 'component',
				...
				'permanentChecking' => true,
				'warning'           => 'PHP dom extension is required.',
				'success'           => 'PHP dom extension is installed.',
			],
			[
				'type'              => 'component',
			...
			[
				...
				'permanentChecking' => true,
				'warning'           => 'PHP filter extension is required.',
				'success'           => 'PHP filter extension is installed.',
			],
			[
				'type'              => 'component',
				...
				'permanentChecking' => true,
				'warning'           => 'PHP hash extension is required.',
				'success'           => 'PHP hash extension is installed.',
			],
			[
				'type'              => 'component',
			...
			[
				...
				'permanentChecking' => true,
				'warning'           => 'PHP pcre extension is required.',
				'success'           => 'PHP pcre extension is installed.',
			],
			[
				'type'              => 'component',
			...
			[
				...
				'permanentChecking' => true,
				'warning'           => 'PHP session extension is required.',
				'success'           => 'PHP session extension is installed.',
			],
			[
				'type'              => 'component',
		...
		$isImagickEnabled = (extension_loaded('imagick') && class_exists('\Imagick'));
		$imagickChecker = [
			'type'              => 'component',
