...
return [
    ...
    'compatibility_title' => 'System compatibility',
    'compatibility_required' => 'The compatibility checking is required to continue.',
...
<br>Note: This process may take some time depending on the selected country. Please don\'t close this window or reload it.',
    ...
    'cron_jobs_guide' => 'Insert the command line below to your system crontab.<br>NOTE: Below timings for running the cron jobs are the recommended, you can change it if you want. Click <a href=":articleUrl" target="_blank">here</a> for more information.',
    'cron_jobs_warning' => 'Cannot find PHP_BIN_PATH in your server. Please find it and replace all {PHP_BIN_PATH} text below with that one. <br>e.g. /usr/bin/php:phpVersion, /usr/bin/php, /usr/lib/php',
    'finish' => 'Finish',
    'finish_title' => 'Finish',
