			...
			<div class="row">
				...
				<div class="col-md-9 page-content">
					<div class="inner-box category-content" style="overflow: visible;">
						<h2 class="title-2">
							<strong><i class="fa-regular fa-pen-to-square"></i> {{ t('create_new_job') }}</strong>
						</h2>
							...
							<div class="col-xl-12">
								...
								>
									...
									<fieldset>
										...
										@includeFirst(
											[config('larapen.core.customizedViewPath') . 'account.company._form', 'account.company._form'],
											['originForm' => 'post']
										)
										
										{{-- POST --}}
										<div class="content-subheading">
											<i class="fa-regular fa-building"></i> <strong>{{ t('ad_details') }}</strong>
										</div>
										...
										@php
											...
											$salaryMin = \App\Helpers\Num::format($salaryMin, 2, '.', '');
											$salaryMax = \App\Helpers\Num::format($salaryMax, 2, '.', '');
										@endphp
										...
										@if (empty(config('country.code')))
											<div class="row mb-3 required">
												<label class="col-md-3 col-form-label{{ $countryCodeError }}" for="country_code">{{ t('your_country') }}
													<sup>*</sup></label>
												<div class="col-md-8">
										...
										<div class="row mb-3">
											...
											<div class="col-md-8">
												<div class="input-group">
													<span class="input-group-text"><i class="fa-solid fa-reply"></i></span>
