			...
			<div class="row">
				...
				<div class="col-md-9 page-content">
					<div class="inner-box category-content" style="overflow: visible;">
						<h2 class="title-2">
							<strong><i class="fa-solid fa-pen-to-square"></i> {{ t('update_my_ad') }}</strong>
									...
									<fieldset>
										...
										<div class="row mb-3">
											<div class="col-md-12 text-center">
												...
												<button id="nextStepBtn" class="btn btn-success btn-lg payableFormSubmitButton"> {{ t('Update') }} </button>
											</div>
										</div>
