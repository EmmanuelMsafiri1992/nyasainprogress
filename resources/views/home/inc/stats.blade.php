@php
	...
	$iconPosts = $sectionOptions['icon_count_listings'] ?? 'fa-solid fa-bullhorn';
	$iconUsers = $sectionOptions['icon_count_users'] ?? 'fa-solid fa-users';
	$iconLocations = $sectionOptions['icon_count_locations'] ?? 'fa-regular fa-map';
