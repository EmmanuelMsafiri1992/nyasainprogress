...
try {
	...
	DB::table('cities')
		...
		->where('name', 'like', 'Ak%yar')
		->update(['name' => 'Akyar']);
	
	// home_sections
	DB::table('home_sections')
		->where('method', 'getLocations')
		->update(['name' => 'Locations & Country Map']);
	...
	if (Schema::hasTable('messages')) {
		...
		DBTool::dropIndexIfExists('messages', 'parent_id');
		DBTool::createIndexIfNotExists('messages', 'parent_id');
		
		DBTool::dropIndexIfExists('messages', 'from_user_id');
		DBTool::createIndexIfNotExists('messages', 'from_user_id');
		
		DBTool::dropIndexIfExists('messages', 'to_user_id');
		DBTool::createIndexIfNotExists('messages', 'to_user_id');
		
		DBTool::dropIndexIfExists('messages', 'deleted_by');
		DBTool::createIndexIfNotExists('messages', 'deleted_by');
	}
	...
	DB::table('settings')->insert([
		...
		'field'       => '[{"name":"social_login_activation","label":"Enable Social Login","type":"checkbox","hint":"Allow users to connect via social networks"},{"name":"separator_1","type":"custom_html","value":"<h3>Facebook</h3>"},{"name":"separator_1_1","type":"custom_html","value":"Create a Facebook App <a href=\\\"https://developers.facebook.com/\\\" target=\\\"_blank\\\">here</a>. The \\\"OAuth redirect URI\\\" is: (<code>http://</code> or <code>https://</code>) <code>domain.tld/auth/facebook/callback</code> or <code>www.domain.tld/auth/facebook/callback</code>"},{"name":"facebook_client_id","label":"Facebook Client ID","type":"text","wrapperAttributes":{"class":"form-group col-md-6"}},{"name":"facebook_client_secret","label":"Facebook Client Secret","type":"text","wrapperAttributes":{"class":"form-group col-md-6"}},{"name":"separator_2","type":"custom_html","value":"<h3>Google+</h3>"},{"name":"separator_2_1","type":"custom_html","value":"Create a Google+ App <a href=\\\"https://console.developers.google.com/\\\" target=\\\"_blank\\\">here</a>. The \\\"Authorized Redirect URI\\\" is: (<code>http://</code> or <code>https://</code>) <code>domain.tld/auth/google/callback</code> or <code>www.domain.tld/auth/google/callback</code>"},{"name":"google_client_id","label":"Google Client ID","type":"text","wrapperAttributes":{"class":"form-group col-md-6"}},{"name":"google_client_secret","label":"Google Client Secret","type":"text","wrapperAttributes":{"class":"form-group col-md-6"}}]',
		'parent_id'   => 0,
		'lft'         => 22,
		'rgt'         => 23,
		'depth'       => 1,
	...
	if (Schema::hasColumn('users', 'is_admin')) {
		DBTool::dropIndexIfExists('users', 'is_admin');
		DBTool::createIndexIfNotExists('users', 'is_admin');
	}
