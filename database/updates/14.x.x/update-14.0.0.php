...
try {
	...
	File::delete(database_path('migrations/2020_10_13_045426_create_password_resets_table.php'));
	File::delete(database_path('migrations/2020_10_13_045426_create_sessions_table.php'));
	...
	File::delete(File::glob(database_path('migrations') . '/2020_10_13_*.php'));
...
try {
	...
	$currentMigrationsNames = [
		...
		'create_companies_table'              => '22_2_create_companies_table',
		'create_resumes_table'                => '22_3_create_resumes_table',
		'create_permission_tables'            => '23_create_permission_tables',
		'create_salary_types_table'           => '24_0_create_salary_types_table',
