...
try {
	...
	// time_zones
	DBTool::dropIndexIfExists('time_zones', 'country_code');
	DBTool::dropIndexIfExists('time_zones', 'time_zone_id');
	
	DBTool::createIndexIfNotExists('time_zones', 'country_code');
	DBTool::createIndexIfNotExists('time_zones', 'time_zone_id');
