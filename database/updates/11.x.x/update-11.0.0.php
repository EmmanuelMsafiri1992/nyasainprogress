...
try {
	...
	foreach ($indexes as $index) {
		DBTool::dropIndexIfExists('users', $index);
	}
	
	// Create indexes
	$indexes = ['email_verified_at', 'phone_verified_at', 'auth_field', 'phone_country'];
	foreach ($indexes as $index) {
		DBTool::createIndexIfNotExists('users', $index);
	}
