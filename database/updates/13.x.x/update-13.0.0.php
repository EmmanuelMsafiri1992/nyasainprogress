...
try {
	...
	File::delete(app_path('Http/Requests/CompanyRequest.php'));
	...
	File::delete(app_path('Http/Requests/ResumeRequest.php'));
	File::delete(app_path('Http/Requests/SendMessageRequest.php'));
	File::delete(app_path('Http/Requests/SendPostByEmailRequest.php'));
...
try {
	...
	DBTool::createIndexIfNotExists('packages', 'type');
	...
	foreach ($indexes as $index) {
		DBTool::createIndexIfNotExists('payments', $index);
	}
